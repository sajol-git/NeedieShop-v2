...
export default function ProductDetailsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const relatedProducts = products.filter(p => p.id !== id).slice(0, 8);
    ...
    <div className="min-h-screen bg-white pb-20">
      ...
      <main className="pt-20 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav className="flex items-center gap-2 text-sm text-gray-400 mb-8">
          <Link href="/shop" className="hover:text-gray-900 transition-colors">Women</Link>
          <span className="text-gray-300">›</span>
          <Link href="/shop" className="hover:text-gray-900 transition-colors">Shoes</Link>
          <span className="text-gray-300">›</span>
          <span className="text-gray-900 font-medium">Sneakers</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 mb-20">
          ...
          <div className="flex flex-col pt-4">
            ...
            <div className="space-y-4">
              ...
              {/* 2nd Line: Add to Bag & WhatsApp Order */}
            ...
            {activeTab === 'details' && (
              <div className="space-y-8">
                ...
                <p className="text-gray-600 leading-relaxed text-lg max-w-4xl">
                  Make every step unique. These kicks put a playful twist on a hoops icon by doubling up on everything you love about the AF-1. Layered materials like linen-evoking textiles and synthetic leather pair with an exaggerated midsole and a pop of pastels to bring you double the style.
                </p>
                
                <div className="space-y-4">
                  <h3 className="text-xl font-bold text-gray-900">Benefits</h3>
                  <ul className="space-y-2 list-disc list-inside text-gray-600">
                    <li>With 2 eye stays, 2 mudguards and 2 Swoosh logos, you get a layered aesthetic with double the branding.</li>
                    <li>Stitched leather overlays add durability and texture to the heritage look.</li>
                    <li>Originally designed for performance hoops, the Nike Air cushioning adds lasting comfort.</li>
                  </ul>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-2 list-disc list-inside text-gray-600">
                    <li>Foam midsole</li>
                    <li>Color Shown: Sail/Sea Coral/Indigo Haze/Coral Chalk</li>
      ...
      {/* Sticky Bottom Nav for Product Page */}
      <AnimatePresence>
        {showStickyNav && (
          <motion.div 
            initial={{ y: 100 }}
