        ...
        <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 gap-4">
            ...
            <div className="flex items-center gap-1 sm:gap-2 shrink-0">
              ...
              <Link 
                href={user ? (user.role === 'admin' ? "/admin" : (user.role === 'suspect' ? "/suspect" : "/account")) : "/login"} 
              ...
              >
                <div className="w-10 h-10 flex items-center justify-center">
                  <CartIcon className="w-6 h-6 scale-110" strokeWidth={10} />
                </div>
                {cartCount > 0 && (
              ...
              <div className="flex-1 overflow-y-auto py-6 px-6">
                ...
                <div className="mt-12 pt-12 border-t border-gray-100 space-y-6">
                  ...
                  {user ? (
                    <>
                      <Link 
                        href={user.role === 'admin' ? "/admin" : (user.role === 'suspect' ? "/suspect" : "/account")}
                        onClick={() => setIsMenuOpen(false)}
